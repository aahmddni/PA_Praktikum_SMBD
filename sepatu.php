      ...
      <div class="flex flex-col flex-1">
        ...
        <main class="h-full pb-16 overflow-y-auto">
            <div class="container grid px-6">
                <h2 class="mt-6 mb-4 text-2xl font-semibold text-gray-700">
                    Daftar Sepatu
                </h2>
                <a href="tambah-sepatu.php" class="z-10 px-2.5 py-2 mb-6 text-white bg-blue-500 rounded-lg w-max">
                  Tambah Data
                </a>
                        ...
                        <tbody class="text-center">
                            <?php $i= 1; foreach($shoes as $shoe) : ?>
                                <tr class="bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="detail-sepatu.php?id=<?= $shoe['id_sepatu']; ?>" class="p-1.5 bg-orange-500 hover:bg-orange-600 text-white rounded-md mr-1">
                                            Detail
                                        </a>
                                        <button  onclick="confirmDelete(<?= $shoe['id_sepatu'] ?>)" class="p-1.5 bg-red-500 hover:bg-red-600 text-white rounded-md mr-1">
                                            Delete
                                        </button>
                                    </td>
                                </tr>
