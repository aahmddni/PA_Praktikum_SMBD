<?php 
    ...
    $transactions = get_all_transaksi();
                        ...
                        <tbody class="text-center">
                            <?php $i= 1; foreach($transactions as $transaction) : ?>
                                <tr class="bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="detail-transaksi.php?id=<?= $transaction['id_transaksi']; ?>" class="p-1.5 bg-orange-500 hover:bg-orange-600 text-white rounded-md mr-1">
                                            Detail
                                        </a>
                                        <button class="p-1.5 bg-red-500 hover:bg-red-600 text-white rounded-md mr-1">
                                            Delete
                                        </button>
                                    </td>
                                </tr>
